              ...
              <Card key={plan.id} className="p-6 shadow-card hover:shadow-energy transition-shadow">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-4">
                  <div className="space-y-1">
                    ...
                    <p className="font-medium">{plan.age} years, {plan.gender}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Height/Weight</p>
                    <p className="font-medium">{plan.height}cm, {plan.weight}kg</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Goal</p>
                    <p className="font-medium capitalize">{plan.goal}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Activity Level</p>
                    <p className="font-medium capitalize">{plan.activity_level}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Diet Preferences</p>
                    <p className="font-medium">{plan.diet_preferences.join(", ")}</p>
                  </div>
                  {plan.equipment && (
                    <div className="space-y-1">
